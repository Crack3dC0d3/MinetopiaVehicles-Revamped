...
public class SubCommandRemoveDriver extends SubCommand {
    public SubCommandRemoveDriver() {
        super("removedriver", "Verwijderd een bestuurder van een voertuig", "removedriver <player>", null);
    }
